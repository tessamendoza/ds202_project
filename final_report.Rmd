...
#### How has time spent working changed in various regions of the US?
```{r pressure, echo=FALSE}
...
Time spent doing religious activities has decreased and time spent working has also decreased an equal amount across all regions in the US 
