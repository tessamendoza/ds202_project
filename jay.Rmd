...
time2 %>%  ggplot(aes(x=ACT_WORK, y=ACT_SOCIAL, color = kids)) + 
  geom_smooth(method=lm) + 
  ggtitle(label="Minutes SOCIAL", subtitle="work includes 0") +
  xlab("Minutes WOKR")
